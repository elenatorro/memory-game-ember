...
define('memory-game/components/elm-component', ['exports', 'ember-elm/components/elm-component'], function (exports, _emberElmComponentsElmComponent) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
      return _emberElmComponentsElmComponent['default'];
    }
  });
});
...
var _user$project$ChangeLocale$model = {language: ''};
var _user$project$ChangeLocale$changeLocale = _elm_lang$core$Native_Platform.outgoingPort(
	'changeLocale',
	function (v) {
		return v;
	});
var _user$project$ChangeLocale$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeEnglish':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{language: 'EN'}),
					_1: _user$project$ChangeLocale$changeLocale('EN')
				};
			case 'ChangeSpanish':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{language: 'ES'}),
					_1: _user$project$ChangeLocale$changeLocale('ES')
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$ChangeLocale$Model = function (a) {
	return {language: a};
};
var _user$project$ChangeLocale$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_user$project$ChangeLocale$Model(flags.language),
		{ctor: '[]'});
};
var _user$project$ChangeLocale$Flags = function (a) {
	return {language: a};
};
var _user$project$ChangeLocale$Default = {ctor: 'Default'};
var _user$project$ChangeLocale$ChangeSpanish = {ctor: 'ChangeSpanish'};
var _user$project$ChangeLocale$ChangeEnglish = {ctor: 'ChangeEnglish'};
var _user$project$ChangeLocale$view = function (model) {
	return A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mg-change-locale-buttons'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$ChangeLocale$ChangeEnglish),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('btn btn-small waves-effect waves-light purple darken-2 mg-level-button'),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$ChangeLocale$ChangeSpanish),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('btn btn-small waves-effect waves-light purple darken-2 mg-level-button'),
							_1: {ctor: '[]'}
...
var _user$project$ChangeLocale$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$ChangeLocale$init,
		view: _user$project$ChangeLocale$view,
		update: _user$project$ChangeLocale$update,
...
var Elm = {};
Elm['ChangeLocale'] = Elm['ChangeLocale'] || {};
if (typeof _user$project$ChangeLocale$main !== 'undefined') {
    _user$project$ChangeLocale$main(Elm['ChangeLocale'], 'ChangeLocale', undefined);
}


        if (typeof exports == 'undefined') {
          define('memory-game/elm-modules', ['exports'], function (exports) {
            exports['default'] = Elm;
          });
        } else {
          exports['default'] = Elm;
...
define('memory-game/pods/components/change-locale/component', ['exports', 'ember', 'memory-game/elm-modules'], function (exports, _ember, _memoryGameElmModules) {
  exports['default'] = _ember['default'].Component.extend({
    i18n: _ember['default'].inject.service(),

    language: 'ES',

    setupElm: _ember['default'].on('init', function () {
      this.set('Elm', _memoryGameElmModules['default']);
    }),
    ...
    actions: {
      changeLocale: function changeLocale(ports) {
...
define("memory-game/pods/components/change-locale/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["inline", "elm-component", [], ["src", ["subexpr", "@mut", [["get", "Elm.ChangeLocale", ["loc", [null, [1, 20], [1, 36]]], 0, 0, 0, 0]], [], [], 0, 0], "flags", ["subexpr", "hash", [], ["language", ["get", "language", ["loc", [null, [2, 23], [2, 31]]], 0, 0, 0, 0]], ["loc", [null, [2, 8], [2, 32]]], 0, 0], "setup", ["subexpr", "action", ["changeLocale"], [], ["loc", [null, [3, 8], [3, 31]]], 0, 0], "class", "mg-change-locale"], ["loc", [null, [1, 0], [4, 28]]], 0, 0]],
      locals: [],
      templates: []
    };
  })());
...
define('memory-game/pods/components/game-card/component', ['exports', 'ember', 'memory-game/constants/cards', 'memory-game/constants/game', 'memory-game/config/environment'], function (exports, _ember, _memoryGameConstantsCards, _memoryGameConstantsGame, _memoryGameConfigEnvironment) {
  ...
  exports['default'] = Component.extend({
    classNameBindings: ['isEasy:mg-game-card-flip-container-easy', 'isMedium:mg-game-card-flip-container-medium', 'isHard:mg-game-card-flip-container-hard'],
    ...
    isHard: equal('card.game.level', _memoryGameConstantsGame.Game.Level.hard.NAME),
...
if (!runningTests) {
  require("memory-game/app")["default"].create({"name":"memory-game","version":"0.0.0+063f54d3"});
}
