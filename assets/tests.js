...
define('memory-game/tests/integration/components/game-card-test', ['exports', 'ember', 'ember-qunit', 'memory-game/tests/helpers/start-app', 'memory-game/tests/helpers/setup-games', 'memory-game/constants/store', 'memory-game/constants/game', 'memory-game/constants/cards', 'memory-game/locales/en/translations', 'memory-game/locales/es/translations'], function (exports, _ember, _emberQunit, _memoryGameTestsHelpersStartApp, _memoryGameTestsHelpersSetupGames, _memoryGameConstantsStore, _memoryGameConstantsGame, _memoryGameConstantsCards, _memoryGameLocalesEnTranslations, _memoryGameLocalesEsTranslations) {
  ...
  (0, _emberQunit.test)('it should be able display a game card', function (assert) {
    ...
    _ember['default'].run(function () {
      ...
      assert.equal(_gameCardFrontImage.prop('src'), window.location.origin + '/images/' + _memoryGameConstantsCards.Card.BACK_IMAGE_NAME + '.png');
...
define('memory-game/tests/pods/index/route.jshint', ['exports'], function (exports) {
  'use strict';
...
define('memory-game/tests/serializers/card.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | serializers/card.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'serializers/card.js should pass jshint.');
  });
});
define('memory-game/tests/serializers/game-card.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | serializers/game-card.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'serializers/game-card.js should pass jshint.');
  });
});
define('memory-game/tests/serializers/game.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | serializers/game.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'serializers/game.js should pass jshint.');
  });
});
define('memory-game/tests/services/api.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | services/api.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'services/api.js should pass jshint.');
  });
});
define('memory-game/tests/services/card.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | services/card.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'services/card.js should pass jshint.');
  });
});
define('memory-game/tests/services/route.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | services/route.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'services/route.js should pass jshint.');
  });
});
define('memory-game/tests/services/store.jshint', ['exports'], function (exports) {
  'use strict';
